...
export default function News({ posts }) {
  return (
    <Layout>
      ...
      <div className="space-y-20 mt-8 mb-12 desktop:mt-14">
        {posts.map((post, idx) => {
          return (
            <div
              key={idx}
            ...
            >
              <div>
                <h5 className="text-krokodil-yellow-dark mb-4 font-yanone font-semibold text-base2 desktop:text-2xl">
                  {format(parseISO(post.attributes.date), "d.MM.y")}
                </h5>
                <h3 className="uppercase s3 text-krokodil-yellow-dark desktop:mt-[6px]">
