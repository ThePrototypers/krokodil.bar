    ...
    <Layout>
      ...
      <div className="flex flex-col mt-8 p-2 desktop:p-0 desktop:flex-row desktop:mt-12">
        ...
        <div className="w-full desktop:w-1/3">
          ...
          <div className="desktop:p-2 mb-5"><img src="/img/gallery/Kroko_5.jpeg" /></div>
        </div>
        <div className="w-full desktop:w-1/3">
          <div className="desktop:p-2 mb-5"><img src="/img/gallery/Kroko_Bar1.jpg" /></div>
          <div className="desktop:p-2"><img src="/img/gallery/Kroko_Raucherraum1.jpg" /></div>
        </div>
      </div>
    </Layout >
  )
